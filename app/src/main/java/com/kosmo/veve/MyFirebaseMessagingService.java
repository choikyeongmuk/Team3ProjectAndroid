...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void showNotification(String title,String body){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this,"com.kosmo.veve")
        ...
        NotificationChannel channel = new NotificationChannel("com.kosmo.veve","CHANNEL_NAME",importance);
    ...
    private void sendRegistrationToServer(String token){
        ...
        new AsyncToServer().execute("http://192.168.0.141:8080/veve/fcm/RegisterToken.jsp","token="+token);
        Log.d("token?????","???");
