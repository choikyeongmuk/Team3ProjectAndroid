...
public class F4_Search extends Fragment implements OnMapReadyCallback {
    ...
    protected void search(List<Address> addresses) {
        ...
        marker.title(String.valueOf(edt_search.getText()));
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                String markerSnippet = "위도:" + "37.47905374874273"
                        + " 경도:" + "126.87894165561016";
    ...
    /*public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        LatLng currentLatLng = new LatLng(37.47905374874273, 126.87894165561016);
