...
public class FollowingList extends AppCompatActivity implements Runnable{
    ...
    private void initView() {
        ...
        recyclerViewFollow = (RecyclerView) findViewById(R.id.recycler_view_following);
    }
    ...
    public void run() {
        try {
            ...
            HttpPost httpPost = new HttpPost(UrlCollection.FOLLOWINGLIST);
